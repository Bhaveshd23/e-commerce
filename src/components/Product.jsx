...
const Product = () => {
    ...
    return (
        <>
            <div className="head" style={{ display: "flex", justifyContent: "center", backgroundColor: "aqua" }}>
                <h1>Available Products</h1>
            </div>


            <DropdownButton id="dropdown-basic-button" title="Tap here for categories" className='m-4'>
